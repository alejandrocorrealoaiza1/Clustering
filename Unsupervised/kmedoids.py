...
class KMedoids():
    ...
    def _init_random_medoids(self, X):
        ...
        self.medoids = np.zeros((self.k, n_features))
    ...
    def _create_clusters(self, X, medoids):
        ...
        for sample_i, sample in enumerate(X):
            medoid_i = self._closest_medoid(sample, self.medoids)
    ...
    def predict(self, X):
        ...
        final_clusters = self._create_clusters(X, self.medoids)
